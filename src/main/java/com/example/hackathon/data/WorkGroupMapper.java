...
public interface WorkGroupMapper {
    ...
    /**
     * 修改group的信息(仅限队长)
     * @param groupId,groupname,main_mission,status
     */
    void updateWorkGroup(@Param("groupId") Integer groupId,@Param("groupname") String groupname,@Param("main_mission")String main_mission,@Param("status")Integer status);
